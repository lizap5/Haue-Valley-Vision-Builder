...
export const LINEN_COLORS: LinenColor[] = [
  ...
  { value: "burgundy",     label: "Burgundy",     hex: "#6E0F1E" },
  { value: "navy",         label: "Navy",         hex: "#14213D" },
  { value: "eggplant",     label: "Eggplant",     hex: "#4B1E4F" },
  { value: "lilac",        label: "Lilac",        hex: "#D9C7EE" },
  { value: "light_blue",   label: "Light Blue",   hex: "#A8C4E0" },
  { value: "slate_blue",   label: "Slate Blue",   hex: "#6D7F96" },
