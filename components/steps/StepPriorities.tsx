...
const priorities = [
  ...
  { value: "atmosphere", label: "A space that feels right the moment you walk in", descriptor: "The room says everything before a word is spoken" },
  { value: "stress_free", label: "A day we actually get to enjoy", descriptor: "No running around, no loose ends, just presence" },
  { value: "food_drink", label: "Food and drinks people talk about after", descriptor: "The bar is high and so is the bar cart" },
...
export default function StepPriorities() {
  ...
  function confirm() {
    ...
    router.push("/builder/11");
  }

  return (
    <StepShell step={10} photo="/images/steps/public-3.jpeg">
      <div className="max-w-xl w-full text-center">
        ...
        <h1 className="font-serif font-light text-3xl sm:text-4xl text-hv-charcoal leading-snug mb-3">
          What matters most to you about the day?
        </h1>
